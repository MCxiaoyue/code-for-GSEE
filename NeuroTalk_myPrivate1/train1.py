import os
import torch
from models import models_EVRNet as networks
...
def main(args):
    ...
    model_g = networks.EVRNet_Generator(h_g).cuda()
    ...
    optimizer_g = torch.optim.AdamW(model_g.parameters(), lr=args.lr_g, betas=(0.8, 0.99), weight_decay=0)
...
if __name__ == '__main__':
    ...
    # dataDir = './sample_data'
    dataDir = './processed_dataset_1'
    logDir = './TrainResult_1'
